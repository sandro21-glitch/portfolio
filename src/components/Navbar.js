...
const Navbar = () => {
  ...
  return (
    <header className={`fixed left-0 top-0 z-[999] overflow-hidden bg-navCl ${isNavOpen ? 'h-52' : 'h-14'} md:h-14  w-full text-center py-3 flex items-start transition-[height] ease-linear duration-300`}>
